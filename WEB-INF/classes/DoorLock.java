...
public class DoorLock extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ResultSet rs = MysqlDataStoreUtilities.getDoorlockProducts(); // Fetch doorlocks from the database

            pw.println("<html><head>");
            pw.println("<title>Smart Doorlock Catalog</title>");
            ...
            // Iterate through the result set and display doorlocks
            ...
            pw.println("<p>Error displaying doorlock products: " + e.getMessage() + "</p>");
            pw.println("</body></html>");
        } finally {
