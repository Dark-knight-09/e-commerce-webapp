...
public class SmartLightingServlet extends HttpServlet {
    @Override
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            // Fetch Smart Lighting products from the database
            ResultSet rs = MysqlDataStoreUtilities.getSmartLightingProducts();

            pw.println("<html><head>");
            pw.println("<title>Smart Lighting Catalog</title>");
            pw.println("<link rel='stylesheet' type='text/css' href='style.css'>");
            pw.println("</head><body>");
            pw.println("<div id='content' class='postcard-container'>");

            // Iterate through the ResultSet and display smart lighting products
            while (rs != null && rs.next()) {
                ...
                String productCategory = "SmartLightning"; // Set the product category to Speaker/
            ...
            pw.println("<p>Error displaying smart lighting products: " + e.getMessage() + "</p>");
            pw.println("</body></html>");
        } finally {
            pw.close();
        }
